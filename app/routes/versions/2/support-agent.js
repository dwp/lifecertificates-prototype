...
function normalise(value) {
  ...
  function getMismatches(viewCase, data) {
    ...
    if (data.enteredName !== viewCase.customer.name) {
      mismatches.push({
        field: 'name',
        url: '/life-cert/review/name-difference',
      })
    }
    ...
    if (
      ...
      mismatches.push({
        field: 'address',
        url: '/life-cert/review/address-difference',
      })
    }
    ...
    if (data.telephone !== viewCase.customer.phone) {
      mismatches.push({
        field: 'telephone',
        url: '/life-cert/review/telephone-difference',
      })
    }
    ...
    if (data.witnessName !== viewCase.witness.name) {
      mismatches.push({
        field: 'witnessName',
        url: '/life-cert/review/witness-name-difference',
      })
    }
    ...
    if (data.witnessRole !== viewCase.witness.jobTitle) {
      mismatches.push({
        field: 'witnessRole',
        url: '/life-cert/review/witness-role-difference',
      })
    }
    ...
    if (
      ...
      mismatches.push({
        ...
        url: '/life-cert/review/witness-address-difference',
      })
    }
    ...
    if (data.witnessTelephone !== viewCase.witness.phone) {
      mismatches.push({
        ...
        url: '/life-cert/review/witness-telephone-difference',
      })
    }
  ...
  function handleNextMismatch(req, res, nino) {
    ...
    if (index < mismatches.length) {
      return res.redirect(`${baseUrl}${mismatches[index].url}?nino=${nino}`)
    }

    return res.redirect(`${baseUrl}/life-cert/review/check-answers-final?nino=${nino}`)
  }
